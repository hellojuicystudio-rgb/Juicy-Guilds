...
- [x] Separar Web, Bot, contratos e Studio Engine.
- [x] Criar central operacional para agentes.
...
- [ ] Versionamento e publicação de workflows.
- [ ] Logs e auditoria.
- [ ] Retry, idempotência e limites de taxa.
- [ ] Observabilidade e alertas.
- [ ] Deploy independente de Web e Bot.
